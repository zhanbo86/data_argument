...
//    TextDetector(TextDetecorParams &params, std::string imgDir = "");
    ...
    void segmentSrcProject(cv::Mat &spineGray, vector<Mat> &single_char_vec);
protected:
    //pre-processing
    ...
    void segmentRow(cv::Mat &open_src_in, cv::Mat &gray_src_in, cv::Mat &out, Mat &out_gray, float gap);
private:
