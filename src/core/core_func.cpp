...
//  }
  ...
  Mat showResult(const Mat &result, int img_index) {
    namedWindow("data_enhance", CV_WINDOW_AUTOSIZE);
    ...
    if (1) {
      imshow("data_enhance", img_window);
      waitKey(0);
      destroyWindow("data_enhance");
    }
